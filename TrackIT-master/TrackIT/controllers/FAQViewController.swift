...
//  TrackIT
//
//  Created by Laima Cernius-Ink on 3/27/20.
...
class FAQ: UIViewController {
      ...
      //  view.addSubview(lbl)
        ...
        view1.frame.size.width = screenWidth - 60
                           ...
                           view1.center.x = view.center.x
                            view1.center.y = home.center.y + 75
    ...
    view1.frame.size.width = screenWidth - 50
              ...
              view1.center.x = view.center.x
               view1.center.y = home.center.y + 175
              view1.backgroundColor = color1
           view.addSubview(view1)
        ...
        @objc func draggedView2(_ sender:UIPanGestureRecognizer){
           ...
           UIView.animate(withDuration: 0.4,
                  ...
                  UIView.animate(withDuration: 0.4,
                                      ...
                                      animations: { [weak self] in
                                         ...
                                         self!.view1.center.y =  ((self?.home.center.y)!) + 175
                         ...
                         UIView.animate(withDuration: 0.3,
                                             ...
                                             animations: { [weak self] in
                                                      ...
                                                      self!.view2.center.y =  self!.view1.center.y + 250
         ...
         UIView.animate(withDuration: 0.4,
                                                ...
                                                animations: { [weak self] in
                                                    ...
                                                    self!.view3.center.y = self!.view2.center.y + 250
...
extension FAQ: CBPeripheralManagerDelegate {
...
extension FAQ: CBCentralManagerDelegate {
